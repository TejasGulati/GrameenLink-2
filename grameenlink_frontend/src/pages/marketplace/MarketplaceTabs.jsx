...
import { Package, ShoppingBag, ShoppingCart, ClipboardList, Star, Tag, ShieldCheck, Search, BarChart2 } from 'lucide-react';
...
const MarketplaceTabs = ({
  ...
  const tabs = [
    { 
      ...
      roles: ['distributor', 'admin', 'retailer', 'node'],
      stats: data.products?.length || 0,
    ...
    { 
      ...
      roles: ['retailer', 'admin', 'distributor', 'node'],
      stats: data.orders?.length || 0,
    ...
    { 
      ...
      roles: ['retailer', 'node', 'admin', 'distributor'],
      stats: data.demands?.length || 0,
    ...
    { 
      ...
      icon: <Tag size={18} />, 
      roles: ['admin'],
      stats: data.categories?.length || 0,
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        <div>
          <h1 className="text-3xl font-bold flex items-center gap-2 bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">
            <ShoppingBag className="text-indigo-600" /> Marketplace Dashboard
            {isAdmin && (
