...
import { Loader, Archive, HardDrive, Box, Activity, Wrench, CheckCircle, XCircle, Clock, AlertTriangle } from 'lucide-react';
...
export const statusBadge = (status, type) => {
  const statusMap = {
    node: {
      ...
      maintenance: { color: 'bg-yellow-100 text-yellow-800', icon: <Wrench size={14} /> }
    },
    inventory: {
      stock: { color: 'bg-green-100 text-green-800', icon: <CheckCircle size={14} /> },
      restock: { color: 'bg-red-100 text-red-800', icon: <AlertTriangle size={14} /> }
    },
    maintenance: {
